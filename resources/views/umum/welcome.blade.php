...
<nav class="navbar navbarfont navbar-expand-lg navbar-inverse navbar-dark fixed-top home" style="background-color: rgba(255, 255, 255, 0.7)">
    ...
    <div class="bgtekshome">
        ...
        <div class="tekshome">
            ...
            <p class="isihome anIsi">
                Kredit Rumah & Cek Pembayaran Online
            </p>

            <button class="btn btn-danger btn-lg anBtn">Lihat Perumahan</button>
        </div>
    </div>
</section>
